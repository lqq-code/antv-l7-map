(self["webpackChunkxboilerplate"] = self["webpackChunkxboilerplate"] || []).push([["mf-dep_vendors-node_modules_antd_es_avatar_index_js"],{
...
/* harmony import */ var _grid_hooks_useBreakpoint__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../grid/hooks/useBreakpoint */ "./node_modules/antd/es/grid/hooks/useBreakpoint.js");
/* harmony import */ var _util_responsiveObserve__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../_util/responsiveObserve */ "./node_modules/antd/es/_util/responsiveObserve.js");
...
var InternalAvatar = function InternalAvatar(props, ref) {
  ...
  var groupSize = react__WEBPACK_IMPORTED_MODULE_7__.useContext(_SizeContext__WEBPACK_IMPORTED_MODULE_8__.default);
  ...
  var avatarNodeMergeRef = (0,rc_util_es_ref__WEBPACK_IMPORTED_MODULE_6__.composeRef)(ref, avatarNodeRef);

  var _React$useContext = react__WEBPACK_IMPORTED_MODULE_7__.useContext(_config_provider__WEBPACK_IMPORTED_MODULE_9__.ConfigContext),
  ...
  var needResponsive = Object.keys((0,_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_2__.default)(size) === 'object' ? size || {} : {}).some(function (key) {
    return ['xs', 'sm', 'md', 'lg', 'xl', 'xxl'].includes(key);
  });
  var screens = (0,_grid_hooks_useBreakpoint__WEBPACK_IMPORTED_MODULE_10__.default)(needResponsive);
  var responsiveSizeStyle = react__WEBPACK_IMPORTED_MODULE_7__.useMemo(function () {
    if ((0,_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_2__.default)(size) !== 'object') {
      return {};
    }

    var currentBreakpoint = _util_responsiveObserve__WEBPACK_IMPORTED_MODULE_11__.responsiveArray.find(function (screen) {
   ...
   true ? (0,_util_warning__WEBPACK_IMPORTED_MODULE_12__.default)(!(typeof icon === 'string' && icon.length > 2), 'Avatar', "`icon` is using ReactNode instead of string naming in v4. Please check `".concat(icon, "` at https://ant.design/components/icon")) : 0;
  var prefixCls = getPrefixCls('avatar', customizePrefixCls);
  var sizeCls = classnames__WEBPACK_IMPORTED_MODULE_4___default()((_classNames = {}, (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)(_classNames, "".concat(prefixCls, "-lg"), size === 'large'), (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)(_classNames, "".concat(prefixCls, "-sm"), size === 'small'), _classNames));
  var hasImageElement = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7__.isValidElement(src);
  var classString = classnames__WEBPACK_IMPORTED_MODULE_4___default()(prefixCls, sizeCls, (_classNames2 = {}, (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)(_classNames2, "".concat(prefixCls, "-").concat(shape), !!shape), (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)(_classNames2, "".concat(prefixCls, "-image"), hasImageElement || src && isImgExist), (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__.default)(_classNames2, "".concat(prefixCls, "-icon"), !!icon), _classNames2), className);
  ...
  if (typeof src === 'string' && isImgExist) {
    ...
    childrenToRender = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7__.createElement(rc_resize_observer__WEBPACK_IMPORTED_MODULE_5__.default, {
      ...
      style: (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__.default)((0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__.default)({}, sizeChildrenStyle), childrenStyle)
    }, children));
  } else {
  ...
  delete others.gap;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7__.createElement("span", (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__.default)({}, others, {
    style: (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__.default)((0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__.default)((0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__.default)({}, sizeStyle), responsiveSizeStyle), others.style),
...
var Group = function Group(props) {
  ...
  var cls = classnames__WEBPACK_IMPORTED_MODULE_1___default()(prefixCls, (0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.default)({}, "".concat(prefixCls, "-rtl"), direction === 'rtl'), className);
  ...
  var childrenWithProps = (0,rc_util_es_Children_toArray__WEBPACK_IMPORTED_MODULE_2__.default)(children).map(function (child, index) {
    return (0,_util_reactNode__WEBPACK_IMPORTED_MODULE_5__.cloneElement)(child, {
  ...
  if (maxCount && maxCount < numOfChildren) {
    ...
    childrenShow.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_popover__WEBPACK_IMPORTED_MODULE_6__.default, {
      key: "avatar-popover-key",
      content: childrenHidden,
      trigger: maxPopoverTrigger,
      placement: maxPopoverPlacement,
      overlayClassName: "".concat(prefixCls, "-popover")
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_avatar__WEBPACK_IMPORTED_MODULE_7__.default, {
      style: maxStyle
    }, "+".concat(numOfChildren - maxCount))));
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_SizeContext__WEBPACK_IMPORTED_MODULE_8__.SizeContextProvider, {
      size: size
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Group": function() { return /* reexport safe */ _group__WEBPACK_IMPORTED_MODULE_0__.default; }
/* harmony export */ });
...
var Avatar = _avatar__WEBPACK_IMPORTED_MODULE_1__.default;
