...
[data-prefers-color=dark] .__dumi-default-previewer-target {
  box-shadow: 0 0 0 5px rgba(69, 105, 212, 0.3);
}
...
.__dumi-default-alert:first-child {
  margin-top: 0;
}
.__dumi-default-alert:not([type])::after,
.__dumi-default-alert[type='warning']::after {
  background: #ffc121;
}
.__dumi-default-alert[type='info']::after {
  background: #69b9ff;
}
.__dumi-default-alert[type='success']::after {
  background: #8cd225;
}
.__dumi-default-alert[type='error']::after {
  background: #ff4646;
}
