(self["webpackChunkxboilerplate"] = self["webpackChunkxboilerplate"] || []).push([["mf-dep_vendors-node_modules_ant-design_icons_es_icons_EllipsisOutlined_js-node_modules_rc-menu_es_Su-9cb24f"],{
...
var Menu = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6__.forwardRef(function (props, ref) {
  ...
  var childList = react__WEBPACK_IMPORTED_MODULE_6__.useMemo(function () {
    return (0,_utils_nodeUtil__WEBPACK_IMPORTED_MODULE_13__.parseItems)(children, items, EMPTY_LIST);
  }, [children, items]);
    ...
    return {
      ...
      focus: function focus(options) {
        ...
        if (shouldFocusKey) {
          ...
          (_containerRef$current = containerRef.current) === null || _containerRef$current === void 0 ? void 0 : (_containerRef$current2 = _containerRef$current.querySelector("li[data-menu-id='".concat((0,_context_IdContext__WEBPACK_IMPORTED_MODULE_22__.getMenuId)(uuid, shouldFocusKey), "']"))) === null || _containerRef$current2 === void 0 ? void 0 : (_containerRef$current3 = _containerRef$current2.focus) === null || _containerRef$current3 === void 0 ? void 0 : _containerRef$current3.call(_containerRef$current2, options);
        }
      }
    };
  }); // ======================== Select ========================
  ...
  return (list || []).map(function (opt, index) {
    if (opt && (0,_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_2__.default)(opt) === 'object') {
      var label = opt.label,
          ...
          key = opt.key,
          type = opt.type,
          restProps = (0,_babel_runtime_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_1__.default)(opt, _excluded);
