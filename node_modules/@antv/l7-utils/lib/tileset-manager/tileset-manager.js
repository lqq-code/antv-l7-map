...
var _tile6 = require("./tile");

var _types = require("./types");

var _boundBuffer = require("./utils/bound-buffer");
...
var TilesetManager = function (_EventEmitter) {
  ...
  function TilesetManager(options) {
    ...
    _this.options = {
      ...
      updateStrategy: _types.UpdateTileStrategy.Replace
    };
  ...
  (0, _createClass2.default)(TilesetManager, [{
    ...
    value: function update(zoom, latLonBounds) {
      ...
      var verifyZoom = Math.ceil(zoom);

      if (this.lastViewStates && this.lastViewStates.zoom === verifyZoom && (0, _boundBuffer.isLatLonBoundsContains)(this.lastViewStates.latLonBoundsBuffer, latLonBounds)) {
        return;
      }

      var latLonBoundsBuffer = (0, _boundBuffer.getLatLonBoundsBuffer)(latLonBounds, _const.BOUNDS_BUFFER_SCALE);
      this.lastViewStates = {
        zoom: verifyZoom,
      ...
      var isAddTile = false;
      var tileIndices = this.getTileIndices(verifyZoom, latLonBoundsBuffer);
