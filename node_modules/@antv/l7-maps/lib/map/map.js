...
var _excluded = ["id", "attributionControl", "style", "rotation", "mapInstance", "version", "mapSize"],
...
var L7MapService = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_l7Core.TYPES.MapConfig), _dec3 = (0, _inversify.inject)(_l7Core.TYPES.IGlobalConfigService), _dec4 = (0, _inversify.inject)(_l7Core.TYPES.ICoordinateSystemService), _dec5 = (0, _inversify.inject)(_l7Core.TYPES.IEventEmitter), _dec(_class = (_class2 = function () {
  function L7MapService() {
    ...
    (0, _defineProperty2.default)(this, "handleMiniCameraChanged", function (lng, lat, zoom, bearing, pitch) {
    ...
    (0, _defineProperty2.default)(this, "handleCameraChanged", function () {
  ...
  (0, _createClass2.default)(L7MapService, [{
    key: "setBgColor",
    ...
    value: function () {
      var _init = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee() {
        var _this$config, _this$config$id, id, _this$config$attribut, attributionControl, _this$config$style, style, _this$config$rotation, rotation, mapInstance, _this$config$version, version, _this$config$mapSize, mapSize, rest;

        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this$config = this.config, _this$config$id = _this$config.id, id = _this$config$id === void 0 ? 'map' : _this$config$id, _this$config$attribut = _this$config.attributionControl, attributionControl = _this$config$attribut === void 0 ? false : _this$config$attribut, _this$config$style = _this$config.style, style = _this$config$style === void 0 ? 'light' : _this$config$style, _this$config$rotation = _this$config.rotation, rotation = _this$config$rotation === void 0 ? 0 : _this$config$rotation, mapInstance = _this$config.mapInstance, _this$config$version = _this$config.version, version = _this$config$version === void 0 ? 'L7MAP' : _this$config$version, _this$config$mapSize = _this$config.mapSize, mapSize = _this$config$mapSize === void 0 ? 10000 : _this$config$mapSize, rest = (0, _objectWithoutProperties2.default)(_this$config, _excluded);
                ...
                if (mapInstance) {
                  ...
                  this.map = new _l7Map.Map(_objectSpread({
    ...
    key: "initMiniMap",
    value: function () {
      var _initMiniMap = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee2() {
        var _this2 = this;
