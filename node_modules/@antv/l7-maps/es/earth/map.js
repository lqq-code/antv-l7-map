...
var L7EarthService = (_dec = injectable(), _dec2 = inject(TYPES.MapConfig), _dec3 = inject(TYPES.IGlobalConfigService), _dec4 = inject(TYPES.ICoordinateSystemService), _dec5 = inject(TYPES.IEventEmitter), _dec(_class = (_class2 = function () {
  function L7EarthService() {
    var _this = this;

    _classCallCheck(this, L7EarthService);

    _defineProperty(this, "version", Version.GLOBEL);
    ...
    _defineProperty(this, "bgColor", '#000');
