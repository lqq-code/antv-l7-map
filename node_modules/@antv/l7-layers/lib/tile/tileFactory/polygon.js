...
var VectorPolygonTile = function (_TileFactory) {
  (0, _inherits2.default)(VectorPolygonTile, _TileFactory);
  ...
  function VectorPolygonTile(option) {
    ...
    (0, _classCallCheck2.default)(this, VectorPolygonTile);
  ...
  (0, _createClass2.default)(VectorPolygonTile, [{
    key: "createTile",
...
exports.default = VectorPolygonTile;
