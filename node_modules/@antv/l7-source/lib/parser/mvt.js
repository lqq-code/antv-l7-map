...
exports.default = mapboxVectorTile;
...
var getVectorTile = function () {
  var _ref = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(url, tileParams, tile, coord) {
    var tileUrl;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            tileUrl = (0, _l7Utils.getURLFromTemplate)(url, tileParams);
            return _context.abrupt("return", new Promise(function (resolve) {
              var xhr = (0, _l7Utils.getArrayBuffer)({
                url: tileUrl
              }, function (err, data) {
                if (err || !data) {
                  resolve({
                  ...
                  var vectorTile = new _vectorTile.VectorTile(new _pbf.default(data));
