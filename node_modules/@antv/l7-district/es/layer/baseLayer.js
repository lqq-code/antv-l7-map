...
import { EventEmitter } from 'eventemitter3'; // @ts-ignore

import geobuf from 'geobuf'; // tslint:disable-next-line: no-submodule-imports

import isObject from 'lodash/isObject'; // tslint:disable-next-line: no-submodule-imports

import mergeWith from 'lodash/mergeWith'; // @ts-ignore

import Pbf from 'pbf'; // @ts-ignore
  ...
  _createClass(BaseLayer, [{
    ...
    value: function addPopup() {
      ...
      popupLayer.on(popup.openTriggerEvent, function (e) {
        ...
        _this6.popup = new Popup(_objectSpread({
          closeButton: false
