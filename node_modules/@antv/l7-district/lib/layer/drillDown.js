...
var DrillDownLayer = /*#__PURE__*/function () {
  ...
  _createClass(DrillDownLayer, [{
    ...
    value: function addCountryEvent() {
      ...
      this.provinceLayer.fillLayer.on(drillDownTriggerEvent, function (e) {
        ...
        if (_this.options.regionDrill) {
          ...
          adcode = _const.RegionList[REGION_CODE].child; // 下钻到省级
    ...
    value: function initLayers(scene) {
      ...
      viewList.indexOf('Country') !== -1 && (this.provinceLayer = new _country.default(scene, _objectSpread({}, this.getLayerOption('Province'))));
      viewList.indexOf('Region') !== -1 && (this.regionLayer = new _region.default(scene, this.getLayerOption('Region')));
      viewList.indexOf('Province') !== -1 && (this.cityLayer = new _province.default(scene, this.getLayerOption('City')));
      viewList.indexOf('City') !== -1 && (this.countyLayer = new _city.default(scene, this.getLayerOption('County')));
    }
  }, {
    key: "initLayerEvent",
    ...
    value: function getViewList() {
      ...
      var drillList = _const.DRILL_TYPE_LIST;
