...
export default class ProvinceLayer extends BaseLayer {
    ...
    protected filterLabelData(data: any, adcode: adcodeType): any;
    private addProvinceFillLayer;
}
