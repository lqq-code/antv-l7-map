...
export interface IDrillDownOption {
    ...
    drillDownEvent: (properties: any, type: string, adcode: string | string[]) => void;
}
export declare type DRILL_LEVEL = 'Country' | 'Region' | 'Province' | 'City' | 'County' | 'province' | 'city' | 'county' | 'region';
export {};
