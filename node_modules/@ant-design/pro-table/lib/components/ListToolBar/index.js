...
var ListToolBarTabBar = function ListToolBarTabBar(_ref) {
  ...
  return (0, _jsxRuntime.jsx)("div", {
    ...
    children: tabs.items && tabs.items.length ? (0, _jsxRuntime.jsx)(_tabs.default, {
      activeKey: tabs.activeKey,
      onChange: tabs.onChange,
      tabBarExtraContent: filtersNode,
      children: tabs.items.map(function (tab, index) {
        return (0, _jsxRuntime.jsx)(_tabs.default.TabPane, (0, _objectSpread2.default)({}, tab), tab.key || index);
      })
    }) : filtersNode
  });
};
...
var ListToolBar = function ListToolBar(_ref2) {
  ...
  var searchNode = (0, _react.useMemo)(function () {
    ...
    return (0, _jsxRuntime.jsx)(_input.default.Search, (0, _objectSpread2.default)((0, _objectSpread2.default)({
      style: {
        width: 200
      },
  ...
  var rightTitleDom = (0, _react.useMemo)(function () {
    ...
    return (0, _jsxRuntime.jsxs)(_space.default, {
      ...
      children: [hasTitle && searchNode ? (0, _jsxRuntime.jsx)("div", {
        className: "".concat(prefixCls, "-search"),
        children: searchNode
      }) : null, !multipleLine ? filtersNode : null, actionDom, (settings === null || settings === void 0 ? void 0 : settings.length) ? (0, _jsxRuntime.jsx)(_space.default, {
        size: 12,
        align: "center",
