...
var DropdownButton = function DropdownButton(_ref) {
  ...
  var menu = (0, _jsxRuntime.jsx)(_menu.default, {
    ...
    children: menus === null || menus === void 0 ? void 0 : menus.map(function (item) {
      return (0, _jsxRuntime.jsx)(_menu.default.Item, {
        children: item.name
      }, item.key);
    })
  });
  return (0, _jsxRuntime.jsx)(_dropdown.default, {
    ...
    children: (0, _jsxRuntime.jsxs)(_button.default, {
      style: style,
      children: [children, " ", (0, _jsxRuntime.jsx)(_icons.DownOutlined, {})]
    })
  });
};
...
var TableDropdown = function TableDropdown(_ref2) {
  ...
  return (0, _jsxRuntime.jsx)(_dropdown.default, {
    ...
    children: (0, _jsxRuntime.jsx)("a", {
      style: style,
      children: children || (0, _jsxRuntime.jsx)(_icons.EllipsisOutlined, {})
    })
  });
};
