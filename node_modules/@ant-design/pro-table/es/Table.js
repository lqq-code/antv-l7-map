...
function TableRender(props) {
  ...
  var baseTableDom = _jsx(_Table, _objectSpread(_objectSpread({}, getTableProps()), {}, {
    rowKey: rowKey
  }));
  /** 自定义的 render */
  ...
  var tableContentDom = useMemo(function () {
    if (props.editable && !props.name) {
      ...
      return _jsxs(_Fragment, {
        children: [toolbarDom, alertDom, /*#__PURE__*/_createElement(ProForm, _objectSpread(_objectSpread({
          ...
          contentRender: function contentRender(items) {
            ...
            return _jsx("div", {
              ...
              children: _jsx(_Spin, _objectSpread({
                size: "large"
              }, loadingProps))
            });
          }
    ...
    return _jsxs(_Fragment, {
      children: [toolbarDom, alertDom, counter.editableForm || !props.editable ? tableDom : null]
  ...
  cardProps === false || !!props.name ? tableContentDom : _jsx(ProCard, _objectSpread(_objectSpread({
    ghost: props.ghost,
  ...
  var proTableDom = _jsxs("div", {
    className: classNames(className, _defineProperty({}, "".concat(className, "-polling"), action.pollingLoading)),
    style: style,
    ref: counter.rootDomRef,
    children: [isLightFilter ? null : searchNode, type !== 'form' && props.tableExtraRender && _jsx("div", {
...
var ProTable = function ProTable(props) {
  ...
  var searchNode = search === false && type !== 'form' ? null : _jsx(FormRender, {
    pagination: pagination,
  ...
  var toolbarDom = toolBarRender === false ? null : _jsx(Toolbar, {
  ...
  var alertDom = propsRowSelection !== false ? _jsx(Alert, {
    selectedRowKeys: selectedRowKeys,
    selectedRows: selectedRowsRef.current,
  ...
  return _jsx(TableRender, _objectSpread(_objectSpread({}, props), {}, {
    name: isEditorTable,
...
var ProviderWarp = function ProviderWarp(props) {
  ...
  return _jsx(Container.Provider, {
    initialState: props,
    children: _jsx(ConfigProviderWrap, {
      children: _jsx(ErrorComponent, {
