...
function BaseFormComponents(props) {
  ...
  return (// 增加国际化的能力，与 table 组件可以统一
    _jsx(FieldContext.Provider, {
      ...
      children: _jsx(ProFormContext.Provider, {
        value: formatValues,
        children: _jsx(_ConfigProvider.SizeContext.Provider, {
          value: rest.size || sizeContextValue,
          children: _jsx(GridContext.Provider, {
            value: {
              grid: grid,
              colProps: colProps
            },
            children: _jsxs(_Form, _objectSpread(_objectSpread({
              ...
              initialValues: syncToUrlAsImportant ? _objectSpread(_objectSpread({}, rest.initialValues), urlParamsMergeInitialValues) : _objectSpread(_objectSpread({}, urlParamsMergeInitialValues), rest.initialValues),
              ...
              onFinish: function () {
                var _onFinish = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
