...
class ServiceGenerator {
    constructor(config, openAPIData) {
        ...
        this.finalPath = '';
        this.config = Object.assign({ projectName: 'api', templatesFolder: (0, path_1.join)(__dirname, '../', 'templates') }, config);
    ...
    getTypeName(operationObject) {
        var _a, _b, _c, _d, _e;
        const namespace = this.config.namespace ? `${this.config.namespace}.` : '';
        const customeTypeName = ((_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.hook) === null || _b === void 0 ? void 0 : _b.customTypeName) || ((_d = (_c = this.config) === null || _c === void 0 ? void 0 : _c.hook) === null || _d === void 0 ? void 0 : _d.customFunctionName);
        return resolveTypeName(`${namespace}${(_e = customeTypeName === null || customeTypeName === void 0 ? void 0 : customeTypeName(operationObject)) !== null && _e !== void 0 ? _e : operationObject.operationId}Params`);
    }
    getFuncationName(data) {
        ...
        return this.config.hook && this.config.hook.customFunctionName
            ...
            : data.operationId
                ? this.resolveFunctionName((0, util_1.stripDot)(data.operationId), data.method)
        ...
        return Object.keys(this.apiData)
            ...
            !api.path.includes('${'))
                ...
                try {
                    ...
                    return Object.assign(Object.assign({}, newApi), { functionName, typeName: this.getTypeName(newApi), path: getPrefixPath(), pathInComment: formattedPath.replace(/\*/g, '&#42;'), hasPathVariables: formattedPath.includes('{'), hasApiPrefix: !!this.config.apiPrefix, method: newApi.method, 
    ...
    resolveFileTP(obj) {
        ...
        const props = (resolved.props && resolved.props.length > 0 &&
        ...
        Object.keys(this.openAPIData.paths || {}).forEach((p) => {
            ...
            ['get', 'put', 'post', 'delete', 'patch'].forEach((method) => {
                ...
                if (props.length > 0 && data) {
                    data.push([
                        {
                            typeName: `${this.getFuncationName(Object.assign(Object.assign({}, operationObject), { method, path: p }))}Params`,
    ...
    resolveEnumObject(schemaObject) {
        ...
        switch (this.config.enumStyle) {
            case 'enum':
                ...
                break;
            case 'string-literal':
                enumStr = Array.from(new Set(enumArray.map((v) => typeof v === 'string' ? `"${v.replace(/"/g, '"')}"` : getType(v)))).join(' | ');
                break;
            default:
                break;
        }
